...
result_fraction_plus = int(fraction_1_numerator) / int(fraction_1_denominator) + int(fraction_2_numerator) / int(fraction_2_denominator)
result_fraction_multiplication = int(fraction_1_numerator) / int(fraction_1_denominator) * int(fraction_2_numerator) / int(fraction_2_denominator)

print(result_fraction_plus)
print(result_fraction_multiplication)

fraction_1 = fractions.Fraction(int(fraction_1_numerator), int(fraction_1_denominator))
fraction_2 = fractions.Fraction(int(fraction_2_numerator), int(fraction_2_denominator))
